...
public class UserService {
    //good use of static for the route to the file which speciefies the connection to the DB 
    private static final String DB_FILE = "db.json";
    //good use for the final specifier for the ObjectMapper.
    //  By reciving a variable only once.In our case what charaeteristics the objecrt has. We can stau safe.
...
//made fucntion to verify db file existence
    public boolean verifyDB(){
        File dbFile = new File(DB_FILE);
                ...
                // the opposite is true so we return true directly, without needing else\
                //because JAva can handle it.
                return true;
    }
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                for (int i = 0; i < users.size(); i++) {
                    ...
                    //we keep the conversion to Text because email is saved in JSON.
